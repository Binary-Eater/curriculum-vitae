...
[[https://github.com/Binary-Eater/curriculum-vitae/releases][releases page]]. I use Xu Cheng's [[https://github.com/xu-cheng/latex-action][latex-action]] GitHub Action to simmplify the
automation.
